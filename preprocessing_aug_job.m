%-----------------------------------------------------------------------
% Job saved on 20-Aug-2018 19:40:27 by cfg_util (rev $Rev: 6942 $)
% spm SPM - SPM12 (7219)
...
%clear matlabbatch; 
%%
matlabbatch{1}.spm.temporal.st.scans = funFiles;
%%
...
%matlabbatch{3}.spm.spatial.coreg.estimate.source = {'/Users/carrielin/Documents/MATLAB/speech_motor_project/1_Data/1/1_002_t1_mprage_sag_p2_iso_20180331/maou_20180331_20180331_001_002_t1_mprage_sag_p2_iso.nii,1'};
matlabbatch{3}.spm.spatial.coreg.estimate.source = fullfile(mainDir,'1_Data',subj,'t1','*.nii');
...
matlabbatch{4}.spm.spatial.preproc.tissue(1).tpm = {'/Users/carrielin/Documents/MATLAB/spm12/tpm/TPM.nii,1'};
matlabbatch{4}.spm.spatial.preproc.tissue(1).ngaus = 1;
matlabbatch{4}.spm.spatial.preproc.tissue(1).native = [1 0];
matlabbatch{4}.spm.spatial.preproc.tissue(1).warped = [0 0];
matlabbatch{4}.spm.spatial.preproc.tissue(2).tpm = {'/Users/carrielin/Documents/MATLAB/spm12/tpm/TPM.nii,2'};
matlabbatch{4}.spm.spatial.preproc.tissue(2).ngaus = 1;
matlabbatch{4}.spm.spatial.preproc.tissue(2).native = [1 0];
matlabbatch{4}.spm.spatial.preproc.tissue(2).warped = [0 0];
matlabbatch{4}.spm.spatial.preproc.tissue(3).tpm = {'/Users/carrielin/Documents/MATLAB/spm12/tpm/TPM.nii,3'};
matlabbatch{4}.spm.spatial.preproc.tissue(3).ngaus = 2;
matlabbatch{4}.spm.spatial.preproc.tissue(3).native = [1 0];
matlabbatch{4}.spm.spatial.preproc.tissue(3).warped = [0 0];
matlabbatch{4}.spm.spatial.preproc.tissue(4).tpm = {'/Users/carrielin/Documents/MATLAB/spm12/tpm/TPM.nii,4'};
matlabbatch{4}.spm.spatial.preproc.tissue(4).ngaus = 3;
matlabbatch{4}.spm.spatial.preproc.tissue(4).native = [1 0];
matlabbatch{4}.spm.spatial.preproc.tissue(4).warped = [0 0];
matlabbatch{4}.spm.spatial.preproc.tissue(5).tpm = {'/Users/carrielin/Documents/MATLAB/spm12/tpm/TPM.nii,5'};
matlabbatch{4}.spm.spatial.preproc.tissue(5).ngaus = 4;
matlabbatch{4}.spm.spatial.preproc.tissue(5).native = [1 0];
matlabbatch{4}.spm.spatial.preproc.tissue(5).warped = [0 0];
matlabbatch{4}.spm.spatial.preproc.tissue(6).tpm = {'/Users/carrielin/Documents/MATLAB/spm12/tpm/TPM.nii,6'};
...
%matlabbatch{5}.spm.spatial.normalise.write.subj.resample = {'/Users/carrielin/Documents/MATLAB/speech_motor_project/1_Data/1/1_002_t1_mprage_sag_p2_iso_20180331/maou_20180331_20180331_001_002_t1_mprage_sag_p2_iso.nii,1'};

matlabbatch{5}.spm.spatial.normalise.write.subj.resample = fullfile(mainDir,'1_Data',subj,'t1','*.nii');
...
matlabbatch{6}.spm.spatial.normalise.write.subj(1).def(1) = cfg_dep('Segment: Forward Deformations', substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','fordef', '()',{':'}));
...
matlabbatch{6}.spm.spatial.normalise.write.subj(2).def(1) = cfg_dep('Segment: Forward Deformations', substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','fordef', '()',{':'}));
...
matlabbatch{6}.spm.spatial.normalise.write.subj(3).def(1) = cfg_dep('Segment: Forward Deformations', substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','fordef', '()',{':'}));
...
matlabbatch{6}.spm.spatial.normalise.write.subj(4).def(1) = cfg_dep('Segment: Forward Deformations', substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','fordef', '()',{':'}));
matlabbatch{6}.spm.spatial.normalise.write.subj(4).resample(1) = cfg_dep('Realign: Estimate & Reslice: Realigned Images (Sess 4)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sess', '()',{4}, '.','cfiles'));
...
matlabbatch{7}.spm.spatial.smooth.data(3) = cfg_dep('Normalise: Write: Normalised Images (Subj 3)', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{3}, '.','files'));
matlabbatch{7}.spm.spatial.smooth.data(4) = cfg_dep('Normalise: Write: Normalised Images (Subj 4)', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{4}, '.','files'));
